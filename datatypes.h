...
typedef struct {
	...
	float l_battery_regen_cut_start;	// test 62V
	float l_battery_regen_cut_end;		// test 67V
...
typedef enum {
	...
	CAN_PACKET_STATUS_7						= 69,
	CAN_PACKET_STATUS_8						= 70,
	CAN_PACKET_STATUS_9						= 71,
	CAN_PACKET_STATUS_10					= 72,
	CAN_PACKET_STATUS_11					= 73,
	CAN_PACKET_STATUS_12					= 74,
